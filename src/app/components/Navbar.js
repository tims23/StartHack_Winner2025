...
export default function Navbar({children}) {
  ...
  const [position, setPosition] = useState([77.706923, 24.398373]); // Default category is 'category1'
...
´          <KrishiMap width={isDrawerOpen ? "calc(100% - 620px)" : "100%"} small={isDrawerOpen} position={position} ></KrishiMap>
